...
# Columns to encode
binary_cols = ['TypeofContact', 'Gender']  # can use LabelEncoder
ordinal_cols = ['CityTier']                # has natural order
nominal_cols = ['Occupation', 'MaritalStatus', 'Designation', 'ProductPitched']
